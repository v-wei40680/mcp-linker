...
export default function About() {
  const features = [
    ...
    },
    {
      ...
      description: "Works with Claude Desktop, Cursor, VS Code, Cline, and more"
    },
    {
    ...
    <div className="container mx-auto px-6 py-8 max-w-4xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Star us on GitHub if you find this useful!</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              ...
              <Button 
                variant="outline" 
                onClick={() => open('https://github.com/milisp/mcp-linker/releases')}
                className="w-full"
              >
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              <Button 
                onClick={() => open('https://discord.gg/G9uJxjpd')} 
                className="w-full"
              >
      ...
      <div className="text-center mt-12 pt-8 border-t">
        <p className="text-muted-foreground">
          Made with <Heart className="h-4 w-4 inline text-red-500" /> by the MCP Linker team
        </p>
      </div>
    </div>
  );
